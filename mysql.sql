-- Active: 1697195541440@@127.0.0.1@3306@oidc_op
CREATE DATABASE OIDC_OP
...
insert into user 
(user_uuid,user_name,user_sex,user_birthday,user_id_number,user_location,user_school,user_intro,user_nick_name,user_telephone,user_email,user_password,user_avatar)
VALUES ("c2913757-9a8d-4148-88f6-49eb24cdd76a","高洋","男","1999-02-03","421022199902039999","192.168.1.1","xxx大学","这是个人简介","陨墨","12354654879","12125465464@qq.com","123123","")

SELECT * FROM `user` WHERE user_telephone = '12354654879' or user_email = "12354654879"
